...
int main(int argc, char ** argv)
{
    ...
    texture_1.loadFromFile("images_2/block.png");
    texture_2.loadFromFile("images_2/background.jpg");
    texture_3.loadFromFile("images_2/ball.png");
    texture_4.loadFromFile("images_2/paddle.png");
